...
def main() -> None:
    ...
    knowledge_graph = LocalKnowledgeGraph(ttl_path=Path("data/processed/knowledge_graph.ttl"))
    assistant = ArticleRAGPipeline(retriever=retriever, knowledge_graph=knowledge_graph)
    print("Ask for the abstract of an academic paper. Type 'exit' or 'quit' to stop.")
